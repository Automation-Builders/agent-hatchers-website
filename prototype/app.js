(() => {
  ...
  function welcome(){return `<div class="stage welcome-grid"><div><span class="eyebrow">Made for ${escapeHtml(company)}</span><h1>Let’s hatch your first agent.</h1><p class="lead">This is your private space to create an agent that works the way your team does. Name it, describe how it should look, watch three designs hatch, and pick your favourite.</p><div class="actions">${button('Start hatching →','next')}</div></div><div class="welcome-art" aria-hidden="true"><div class="preview-egg"></div></div></div>`;}
